...
# TODO:
# export biomass to .js (scatter line plot to interactively calculate the growth rate)
# export biomass and rates to .js (scatter line plot to interactively calculate the uptake/secretion rates)
